...
def train():
    ...
    # Split data temporally (90% train, 5% val, 5% test) to include recent 2025/26 data
    ...
    joblib.dump(scaler, "src/app/models/jepa_scaler.pkl")
    print(f"✅ Model saved to {MODEL_SAVE_PATH}")
    print(f"✅ Scaler saved to src/app/models/jepa_scaler.pkl")
